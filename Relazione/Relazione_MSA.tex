...
\item{\textbf{Subscription Queue}: i client scrivono su questa coda per sottoscriversi in modalit\'a \textit{content-based} ad un determinato \textit{topic}}
\end{itemize}
...
\\
Per la ricezione di messaggi, ogni client ha a disposizione una coda personale, la quale viene creata al momento dell'ingresso del nodo nel sistema. Inoltre i risultati delle richieste e le notifiche in arrivo vengono lette da ciascun nodo mobile direttamente dalla sua coda dedicata.
