...
\includegraphics[width=0.9\linewidth,height=4cm]{1alsec.jpg} % Include the image placeholder.png
%\label{fig:1 pull ogni secondo}
\caption{1 pull ogni secondo}
\end{subfigure}
\begin{subfigure}{0.5\textwidth}
\includegraphics[width=0.9\linewidth,height=4cm]{5alsec.jpg} % Include the image placeholder.png
\caption{1 pull ogni 5 secondi}
\end{subfigure}
\begin{subfigure}{0.5\textwidth}
\includegraphics[width=0.9\linewidth,height=4cm]{10alsec.jpg} % Include the image placeholder.png
\caption{1 pull ogni 10 secondi}
\end{subfigure}
\begin{subfigure}{0.5\textwidth}
\includegraphics[width=0.9\linewidth,height=4cm]{20alsec.jpg} % Include the image placeholder.png
\caption{1 pull ogni 20 secondi}
\end{subfigure}
\end{figure}
