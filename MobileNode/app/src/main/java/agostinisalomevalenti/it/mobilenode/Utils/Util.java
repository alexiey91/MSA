...
public class Util {
    ...
    //Metodo per poter leggere le credenziali aws da file
    ...
    //Metodo per poter leggere il livello della batteria sul dispotivo.
    ...
    /*
    * Implementa una operazione di subscription o di Unsubscription attravero un oggetto JSON
    ...
    *  */
    ...
    /*
    * Implementa una operazione di publish attravero un oggetto JSON su un certo topic
    * userId: androidid */
